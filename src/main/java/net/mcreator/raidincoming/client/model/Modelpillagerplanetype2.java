...
public class Modelpillagerplanetype2<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("raidincoming", "modelpillagerplanetype_2"),
			"main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(0, 0).addBox(-7.0F, 3.0F, -20.0F, 14.0F, 1.0F, 34.0F, new CubeDeformation(0.0F)).texOffs(134, 36)
		...
		PartDefinition cube_r1 = body.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(108, 123).addBox(-2.0F, -30.0447F, 15.4433F, 4.0F, 4.0F, 8.0F, new CubeDeformation(0.0F))
						.texOffs(144, 122).addBox(31.0F, -30.0447F, 15.4433F, 4.0F, 4.0F, 8.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-16.0F, 19.0F, -44.0F, -0.3927F, 0.0F, 0.0F));
		PartDefinition cube_r2 = body.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(62, 0).addBox(-5.0F, -8.6508F, -16.9197F, 10.0F, 7.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, -11.0F, -0.3927F, 0.0F, 0.0F));
		PartDefinition cube_r3 = body.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(0, 0).addBox(-2.5F, -3.0F, 0.0F, 0.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 8.0F, -1.0F, 0.0F, -0.3927F, 0.0F));
		PartDefinition cube_r4 = body.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(21, 0).addBox(2.5F, -3.0F, 0.0F, 0.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 8.0F, -1.0F, 0.0F, 0.3927F, 0.0F));
		PartDefinition cube_r5 = body.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(0, 35).addBox(3.0F, -6.2426F, -7.6569F, 4.0F, 10.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(0, 54)
