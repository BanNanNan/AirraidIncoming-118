...
public class Modelaa4headbasehead_45dgrev2<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "aa4headbasehead_45dgrev2"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition base = partdefinition.addOrReplaceChild("base",
				CubeListBuilder.create().texOffs(0, 28)
						.addBox(-8.0F, -8.0F, -14.0F, 16.0F, 8.0F, 22.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
		...
		PartDefinition cube_r1 = base.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(21, 58).addBox(-6.0F, -11.0359F, -3.134F, 12.0F, 11.0F, 1.0F,
		...
		PartDefinition cube_r2 = cannon.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(36, 79)
						.addBox(9.0F, -6.0F, -8.0F, 4.0F, 6.0F, 14.0F, new CubeDeformation(0.0F)).texOffs(0, 79)
						...
						.addBox(-14.0F, -6.0F, -4.0F, 1.0F, 12.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(95, 13)
						.addBox(-9.0F, -6.0F, -4.0F, 1.0F, 12.0F, 8.0F, new CubeDeformation(0.0F)),
